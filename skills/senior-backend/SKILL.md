---
name: "senior-backend"
description: "Бэкенд: REST/GraphQL API, микросервисы, БД, аутентификация — Node/Express/Fastify, оптимизация PostgreSQL, security, нагрузочное тестирование. Когда проектируешь или ревьюишь серверную часть."
---
