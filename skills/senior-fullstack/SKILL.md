...
description: "Fullstack-скаффолдинг и выбор стека — Next.js, FastAPI, MERN, Django; boilerplate проектов, анализ качества кода. Когда поднимаешь новый проект целиком или выбираешь технологический стек."
---
