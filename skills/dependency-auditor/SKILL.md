...
description: "Аудит зависимостей: уязвимости, лицензии, безопасные апгрейды — анализ CVE, транзитивных рисков, конфликтов лицензий. Когда проверяешь пакеты перед релизом, разбираешь CVE, планируешь мажорный бамп или license-compliance."
---
