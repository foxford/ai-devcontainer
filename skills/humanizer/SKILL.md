---
name: humanizer
description: "Очеловечивание текста — вычищает AI-штампы (раздутые заявления, продающий тон, дежурные слова, вода, следы чат-бота), сохраняя факты, смысл и голос автора. По вики-гайду «Signs of AI writing». Когда просят убрать AI-шность, переписать по-человечески, причесать текст — и перед публикацией README, PR, релиз-ноутов и доков."
license: MIT
metadata:
  version: "2.11.0"
---
