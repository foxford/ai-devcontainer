---
name: "senior-secops"
description: "SecOps и безопасность приложений — SAST/DAST, ремедиация CVE, политики, соответствие SOC2/PCI-DSS/HIPAA/GDPR, секреты, OWASP в CI/CD. Когда проводишь security-аудит, отвечаешь на инцидент или харденишь инфраструктуру."
---
