...
description: "Проектирование системной архитектуры — ADR, выбор стека и БД, микросервисы vs монолит, масштабирование, диаграммы. Когда проектируешь систему, оцениваешь архитектурные решения или делаешь design review."
---
