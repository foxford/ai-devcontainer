...
**Kill criterion:** customer-facing surface + no named a11y owner — STOP. Assign one before scaffolding. Прогони `impeccable → audit` по поверхности и закрепи проверки в CI.
